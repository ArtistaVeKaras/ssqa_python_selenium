...
# solution 1
# print("- Iterate the products list and print the name of all products that have price greater than 25.")
# for i in products:
#     # print(i)
#     if i['price'] > 25:
#         print(i['name'])
...
# # solution 2
# print("Print the name and price of products that are on sale.")
# for i in products:
#     # print(i)
#     if i['is_on_sale']: 
...
# solution 3
print("Print the list of sale products without sale price that you created.")

no_sale_products = []
for i in products:
    if i['is_on_sale'] == True and i['sale_price'] == None: 
        no_sale_products.append(i['name'])
        print(no_sale_products)